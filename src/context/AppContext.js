...
import demosummaData from "../assets/demo/summadata.json";
...
const initialState = {
  data: {
    summa: {
      "@context": [
        "https://summaresume.github.io/skill/context.json",
        {
          gender: {
            "@id": "schema:gender",
            "@type": "@vocab",
  ...
  theme: {
    ...
    layoutblocks: {
      ...
      pikachu: [
        ["skills", "languages", "hobbies", "awards"],
        ["work", "education", "projects", "references"],
      ],
      gengar: [
        ["objective", "skills"],
        ["awards", "languages", "references", "hobbies"],
        ["work", "education", "projects"],
      ],
      castform: [
        ["awards", "languages", "hobbies"],
